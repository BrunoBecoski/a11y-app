      ...
      <article className={styles.content}>
        ...
        <div>
          <p>
            ...
            desenvolvedores front-end, adotar práticas acessíveis desde o início
            é uma forma de construir um ambiente digital mais justo e eficiente.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            motoras tem dificuldade em navegar em um formulário. Essas barreiras
            excluem milhões de pessoas da experiência digital. A acessibilidade
            web é a ponte para superar essas dificuldades, promovendo inclusão
            digital. Além disso, criar interfaces acessíveis beneficia não só
            pessoas com deficiência, mas também melhora a experiência geral de
            todos os usuários. Por exemplo, legendas em vídeos são úteis para
            pessoas que assistem conteúdos em ambientes barulhentos ou que
            preferem não ativar o som.
          </p>
        </div>
...
`}
          ...
          <span>
            ...
            HTML semântico: como criar uma web acessível no blog da Rocketseat.{" "}
          </span>
        </div>
...
.skip-link:focus {
  ...
  z-index: 1000;
            ...
            <ul>
              <li>
                Isso fará com que o link apareça somente quando focado, mantendo
                o design limpo, mas oferecendo acessibilidade para usuários que
...
<span role="alert">A senha deve conter ao menos 8 caracteres.</span>
        ...
        <div>
          ...
          <p>
            ...
            utilizam leitores de tela ou que navegam exclusivamente via teclado.
            Esses testes práticos ajudam a garantir que a experiência real do
            usuário seja satisfatória e sem obstáculos.
          </p>
